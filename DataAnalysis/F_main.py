...
from F_homogeneity import F_homogeneity
from F_anova import F_anova
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(250, 260, 41, 41))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(250, 380, 41, 41))
        ...
        self.listWidget_row.setGeometry(QtCore.QRect(310, 210, 161, 151))
        ...
        self.listWidget_col.setGeometry(QtCore.QRect(310, 390, 161, 31))
        ...
        self.label_4.setGeometry(QtCore.QRect(310, 190, 161, 20))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(310, 370, 161, 20))
        ...
        self.label_10.setGeometry(QtCore.QRect(750, 80, 54, 21))
        self.label_10.setObjectName("label_10")
        self.checkboxes = []
        self.states = []
        self.checkBox_0 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_0.setGeometry(QtCore.QRect(750, 100, 71, 31))
        self.checkBox_0.setObjectName("checkBox_0")
        self.checkboxes.append(self.checkBox_0)
        self.checkBox_1 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_1.setGeometry(QtCore.QRect(750, 130, 121, 31))
        self.checkBox_1.setObjectName("checkBox_1")
        self.checkboxes.append(self.checkBox_1)
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(750, 160, 111, 31))
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkboxes.append(self.checkBox_2)
        self.checkBox_3 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_3.setGeometry(QtCore.QRect(750, 190, 101, 31))
        self.checkBox_3.setObjectName("checkBox_3")
        self.checkboxes.append(self.checkBox_3)
        self.checkBox_4 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_4.setGeometry(QtCore.QRect(750, 220, 101, 31))
        self.checkBox_4.setObjectName("checkBox_4")
        self.checkboxes.append(self.checkBox_4)
        self.checkBox_5 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_5.setGeometry(QtCore.QRect(750, 310, 151, 31))
        self.checkBox_5.setObjectName("checkBox_6")
        self.checkboxes.append(self.checkBox_5)
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(750, 290, 54, 21))
        self.label_11.setObjectName("label_11")
        self.checkBox_6 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_6.setGeometry(QtCore.QRect(750, 340, 151, 31))
        self.checkBox_6.setObjectName("checkBox_6")
        self.checkboxes.append(self.checkBox_6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "因变量列表(E):"))
        self.label_5.setText(_translate("MainWindow", "因子(C):"))
        ...
        self.checkBox_0.setText(_translate("MainWindow", "描述(D)"))
        self.checkBox_1.setText(_translate("MainWindow", "固定和随机效应(F)"))
        self.checkBox_2.setText(_translate("MainWindow", "方差齐性检验(H)"))
        self.checkBox_3.setText(_translate("MainWindow", "布朗-福赛斯(B)"))
        self.checkBox_4.setText(_translate("MainWindow", "韦尔奇(W)"))
        self.checkBox_5.setText(_translate("MainWindow", "按具体分析排除个案(A)"))
        self.checkBox_6.setText(_translate("MainWindow", "成列排除个案(L)"))
        self.label_10.setText(_translate("MainWindow", "统计"))
        self.label_11.setText(_translate("MainWindow", "缺失值"))
        self.menuF.setTitle(_translate("MainWindow", "单因素ANOVA检验"))
    ...
    def Submit(self):
        ...
        for i, row_name in enumerate(row_items):
            for j, col_name in enumerate(col_items):
                ...
                # F检验结果
                if self.states[0]:  # 描述
                    self.anova_window = F_anova()
                    self.anova_window.setupUi(selected_row_name, row_values[i], col_values[j])
                    self.anova_window.show()
                if self.states[2]:  # 方差齐性检验
                    self.result_window = F_homogeneity()
                    self.result_window.setupUi(selected_row_name, row_values[i], col_values[j], self.states)
